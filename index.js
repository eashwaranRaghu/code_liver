...
Y({
  ...
  window.yAce = y
  editor = ace.edit('Developer')
  editor.setTheme('ace/theme/monokai')
  editor.getSession().setMode('ace/mode/c_cpp')
  document.getElementById('Developer').style.fontSize='16px';
...
Y({
  ...
  function cleanupChat () {
    var len
    while ((len = y.share.chat.length) > 16) {
